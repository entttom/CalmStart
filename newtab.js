...
function getStyle(key, value) {
	switch(key) {
		...
		case 'settings_follow_theme':
			return value ? '#options, #options .section, .menu, .bookmark-search-panel, .bookmark-editor-dialog, .column-settings-dialog, .font-preview-dialog { background-color: var(--hntp-background-color) !important; color: var(--hntp-font-color) !important; border-color: var(--hntp-font-color) !important; } #options_nav { background-color: var(--hntp-background-color) !important; color: var(--hntp-font-color) !important; } #options_nav a.current, .menu a:hover { background-color: var(--hntp-highlight-color) !important; color: var(--hntp-highlight-font-color) !important; }' : null;
		case 'settings_match_theme':
			if (!value) return null;
			return '#options, #options .section, .menu, .bookmark-search-panel, .bookmark-editor-dialog, .column-settings-dialog, .font-preview-dialog { background-color:' + getConfig('background_color') + ' !important; color:' + getConfig('font_color') + ' !important; border-color:' + getConfig('shadow_color') + ' !important; } #options_nav { background-color:' + getConfig('background_color') + ' !important; color:' + getConfig('font_color') + ' !important; border-color:' + getConfig('shadow_color') + ' !important; } #options_nav a.current, .font-preview-row:hover, .font-preview-row.selected { background-color:' + getConfig('highlight_color') + ' !important; color:' + getConfig('highlight_font_color') + ' !important; } #options input, #options select, #options textarea, #options button, .bookmark-search-panel input, .bookmark-editor-dialog input, .bookmark-editor-dialog select, .column-settings-dialog input, .font-preview-dialog input, .font-preview-dialog button { background-color:' + getConfig('background_color') + ' !important; color:' + getConfig('font_color') + ' !important; border-color:' + getConfig('shadow_color') + ' !important; }';
		case 'dark_mode':
