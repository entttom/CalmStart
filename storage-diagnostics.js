...
(function(S) {
	...
	S.diagnosticsText = function() {
		...
		var lines = [
			...
			'Bookmark index: ' + ((S.startupMetrics && S.startupMetrics.bookmarkIndexSource) || 'unknown'),
			'Bookmark folders indexed: ' + ((S.startupMetrics && S.startupMetrics.folderCount) || 0),
			'Bookmark index time: ' + ((S.startupMetrics && S.startupMetrics.indexMs != null) ? S.startupMetrics.indexMs + ' ms' : 'unknown'),
			'Storage init time: ' + ((S.startupMetrics && S.startupMetrics.initMs != null) ? S.startupMetrics.initMs + ' ms' : 'unknown'),
	...
	S.updateDevelopmentInfo = function() {
		...
		var fields = {
			...
			dev_bookmark_index: (S.startupMetrics && S.startupMetrics.bookmarkIndexSource) || 'Unknown',
			dev_bookmark_folders: String((S.startupMetrics && S.startupMetrics.folderCount) || 0),
			dev_bookmark_index_ms: (S.startupMetrics && S.startupMetrics.indexMs != null) ? S.startupMetrics.indexMs + ' ms' : 'Unknown',
			dev_storage_init_ms: (S.startupMetrics && S.startupMetrics.initMs != null) ? S.startupMetrics.initMs + ' ms' : 'Unknown',
