...
(function() {
	...
	var de = {
		...
		'Settings follow theme': 'Einstellungen folgen dem Theme',
		...
		'Incognito access': 'Inkognito-Zugriff',
		'History permission': 'Verlaufsberechtigung',
		'Allowed': 'Erlaubt',
		'Not allowed': 'Nicht erlaubt',
		'Granted': 'Erteilt',
		'Not granted': 'Nicht erteilt',
		'Unknown': 'Unbekannt',
		'Link shortcuts': 'Link-Tastenkürzel',
		'Right-click a link and choose “Set shortcut…”. Shortcuts use Alt/⌥ + A-Z or 0-9.': 'Rechtsklick auf einen Link und „Tastenkürzel festlegen…“ wählen. Kürzel verwenden Alt/⌥ + A-Z oder 0-9.',
		'Clear shortcuts': 'Tastenkürzel löschen',
		'No link shortcuts configured.': 'Keine Link-Tastenkürzel eingerichtet.',
		'Remove': 'Entfernen',
		...
		'Hide from Most visited': 'Aus „Meistbesucht“ ausblenden',
		'Reset Most visited order': 'Reihenfolge von „Meistbesucht“ zurücksetzen',
